...
def test_hash_cache_hit_rehashes_the_artifact_before_reusing_its_record(tmp_path, monkeypatch):
...
def test_default_cache_rehashes_same_size_mtime_rewrites(tmp_path):
    workspace = create_candidate(tmp_path, "cache-synthetic")
    artifact = workspace.path / "outputs" / "artifact.json"
